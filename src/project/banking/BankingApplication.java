            ...
            switch (choice) {
                ...
                case 8:
                    ...
                    if (account != null) {
                        ...
                        System.out.println("Loan Amount: Rs " + account.getLoanAmount());
                    } else {
                ...
                case 9:
                	try {
                	Transaction.display(bank.getAccount(fromAccount),bank.getAccount(toAccount),transferAmount);
                	}
                	catch(Exception e)
                	{
                		System.out.println("No Transaction done so Far");
                	}
                	break;
                case 10:
